...
class HealthProfessional(BaseModel):
    ...
    hospital_unit = models.ForeignKey('infrastructure.HospitalUnit', on_delete=models.SET_NULL, null=True, db_column='unidade_id')
...
class Schedule(BaseModel):
    ...
    """
    professional = models.ForeignKey('professionals.HealthProfessional', on_delete=models.CASCADE, db_column='profissional_id')
