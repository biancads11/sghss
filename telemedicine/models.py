...
class TeleconsultationRecord(BaseModel):
    ...
    """
    teleconsultation = models.ForeignKey('telemedicine.Teleconsultation', on_delete=models.CASCADE,
                                         db_column='teleconsulta_id')
    medical_record = models.ForeignKey('patients.MedicalRecord', on_delete=models.CASCADE, db_column='prontuario_id')
    prescription = models.ForeignKey('clinical_service.Prescription', on_delete=models.SET_NULL, null=True, blank=True,
