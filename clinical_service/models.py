...
class Consultation(BaseModel):
    ...
    """
    appointment = models.ForeignKey('clinical_service.Appointment', on_delete=models.CASCADE,
                                    db_column='atendimento_id')
...
class Examination(BaseModel):
    ...
    """
    patient = models.ForeignKey('patients.Patient', on_delete=models.CASCADE, db_column='paciente_id')
    requesting_professional = models.ForeignKey('professionals.HealthProfessional', on_delete=models.SET_NULL,
                                                null=True, db_column='profissional_solicitante_id')
...
class DigitalReceipt(BaseModel):
    ...
    """
    prescription = models.ForeignKey('clinical_service.Prescription', on_delete=models.CASCADE,
                                     db_column='prescricao_id')
    patient = models.ForeignKey('patients.Patient', on_delete=models.CASCADE, db_column='paciente_id')
